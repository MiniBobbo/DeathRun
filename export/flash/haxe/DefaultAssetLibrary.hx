...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/testlevel.png", __ASSET__assets_images_testlevel_png);
		type.set ("assets/images/testlevel.png", AssetType.IMAGE);
		className.set ("assets/images/whiteblock.png", __ASSET__assets_images_whiteblock_png);
		type.set ("assets/images/whiteblock.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/testlevel.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/whiteblock.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:keep class __ASSET__assets_images_testlevel_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_whiteblock_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/testlevel.png") class __ASSET__assets_images_testlevel_png extends flash.display.BitmapData {}
@:bitmap("assets/images/whiteblock.png") class __ASSET__assets_images_whiteblock_png extends flash.display.BitmapData {}
