...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "deathrun", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "deathrun", null, { width: 800, height: 800 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 800, height: 800 });
			#end
